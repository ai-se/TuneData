...
class RF(object):
    def __init__(self):
        ...
        self.tunelst = ["min_samples_split", "min_samples_leaf",
                        "max_leaf_nodes", "n_estimators", "max_features","threshold"]
        self.tune_min = [1, 2, 10, 50, 0.01,0.01]
        self.tune_max = [20, 20, 50, 150, 1,1]
    ...
    def tuned_parameters(self):
        return [{'n_estimators': [50, 151], 'max_features': [0.01, 1.0],
                 ...
                 'max_leaf_nodes': [10, 51],'threshold':[0.01,1]}]
...
class CART(object):
    ...
    def tuned_parameters(self):
        return [{'max_features': [0.01, 1.0], 'max_depth': [1, 50],
                 'min_samples_split': [1, 20], 'min_samples_leaf': [2, 21],"threshold":[0.01,1]}]
